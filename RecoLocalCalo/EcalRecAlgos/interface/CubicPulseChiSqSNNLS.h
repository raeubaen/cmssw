...
#include "RecoLocalCalo/EcalRecAlgos/interface/EigenMatrixTypesT.h"
...
public:
  using SampleVector = typename EigenMatrixTypesT<P>::SampleVector;
  using FullSampleVector = typename EigenMatrixTypesT<P>::FullSampleVector;
  using PulseVector = typename EigenMatrixTypesT<P>::PulseVector;
  using BXVector = typename EigenMatrixTypesT<P>::BXVector;
  using SampleGainVector = typename EigenMatrixTypesT<P>::SampleGainVector;
  using SampleMatrix = typename EigenMatrixTypesT<P>::SampleMatrix;
  using FullSampleMatrix = typename EigenMatrixTypesT<P>::FullSampleMatrix;
  using PulseMatrix = typename EigenMatrixTypesT<P>::PulseMatrix;
  using SamplePulseMatrix = typename EigenMatrixTypesT<P>::SamplePulseMatrix;
  using SampleDecompLLT = typename EigenMatrixTypesT<P>::SampleDecompLLT;
  using PulseDecompLDLT = typename EigenMatrixTypesT<P>::PulseDecompLDLT;
  using SingleMatrix = typename EigenMatrixTypesT<P>::SingleMatrix;
  using SingleVector = typename EigenMatrixTypesT<P>::SingleVector;
